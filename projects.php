...
<?php include('includes/header.php'); ?>
    ...
    <div class="page-content">
		<!-- inner page banner -->
        <div class="dlab-bnr-inr dlab-bnr-inr-lg overlay-primary-middle bg-pt" style="background-image:url(images/projects-banner.jpg);">
            <div class="container">
            ...
            <div class="section-full bg-white content-inner-1">
				<div class="container">
					<div class="section-head text-center">
						<p class="pre-title">PORTA VITAE MAURIS VEL</p>
						<h2 class="head-title m-b10">Our Best Projects</h2>
					</div>
					<div class="row">
